...
export function BillCheckerSection() {
    return (
        <section id="cek-tagihan" className="relative z-[60] px-4 pb-20">
            <div className="container max-w-[1200px] mx-auto">
                <motion.div
                    initial={{ y: 50, opacity: 0 }}
                    whileInView={{ y: 0, opacity: 1 }}
                    viewport={{ once: true }}
                    className="bg-white rounded-[30px] shadow-[0px_10px_40px_0px_rgba(0,0,0,0.1)] p-8 lg:p-12 -mt-[150px] relative z-[60]"
                >
